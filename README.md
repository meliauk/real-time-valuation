...
<div align="center">
  <h1>
    <span style="font-size:2.2rem;font-weight:800;background:linear-gradient(135deg,#6366f1,#a855f7,#ec4899);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">基攻宝</span>
  </h1>
  <p style="font-size:1rem;color:#94a3b8;margin:8px 0 20px;">
    实时基金估值 &nbsp;·&nbsp; 全球行情追踪 &nbsp;·&nbsp; 财经资讯聚合
  </p>
  <p>
...
<b style="font-size:1.05rem;color:#7e22ce;">📈 基金实时估值</b><br/>
<span style="color:#64748b;">盘中实时跟踪基金净值涨跌，自动计算今日盈亏与累计收益</span>

<b style="color:#ec4899;">▌T+2「实时」</b> 持仓股票当日涨跌按占比加权推算<br/>
<b style="color:#6366f1;">▌T+1「预测」</b> 仅依据持仓计算，不覆盖 fundgz 估算值

</td>
<td width="50%" valign="top" style="background:#eff6ff;border-radius:12px;border-left:4px solid #3b82f6;padding:14px 16px;">

<b style="font-size:1.05rem;color:#1d4ed8;">💼 持仓管理</b><br/>
<span style="color:#64748b;">记录份额与成本价，仪表盘聚合展示，T+1 确认后自动推进昨日基数，漏日回放补齐</span>

<sub>持有金额 · 今日盈亏 · 累计盈亏 · 综合涨跌幅 · 多维度排序</sub>
...
<b style="font-size:1.05rem;color:#047857;">🌍 全球指数</b><br/>
<span style="color:#64748b;">实时追踪全球主要市场指数，自定义勾选关注，按本地时区识别盘中/收盘状态</span>

<sub>A股 · 港股 · 美股 · 日韩台 · 欧股 · 红涨绿跌</sub>

</td>
<td width="50%" valign="top" style="background:#fffbeb;border-radius:12px;border-left:4px solid #f59e0b;padding:14px 16px;">

<b style="font-size:1.05rem;color:#b45309;">⭐ 自选股票</b><br/>
<span style="color:#64748b;">跨市场模糊搜索（代码 / 拼音 / 名称），一键添加自选，实时价格与涨跌幅展示</span>

<sub>A股 · 港股 · 美股 · 日韩台 · 欧股 · 按涨跌幅排序</sub>
...
<b style="font-size:1.05rem;color:#be123c;">📰 财经资讯</b><br/>
<span style="color:#64748b;">新浪、东方财富、海外 RSS 多源聚合，时间线展示，自动刷新；海外源可按需开关</span>

<sub>关键词黑名单 · 胶囊标签管理 · 已读自动标记</sub>

</td>
<td width="50%" valign="top" style="background:#fdf4ff;border-radius:12px;border-left:4px solid #d946ef;padding:14px 16px;">

<b style="font-size:1.05rem;color:#a21caf;">📊 走势图表</b><br/>
<span style="color:#64748b;">历史净值走势 + 盘中迷你走势图，基金详情一页呈现</span>

<sub>基金类型 · 规模 · 经理 · 同类排名 · 业绩评价 · ECharts 交互</sub>
...
<b style="font-size:1.05rem;color:#0369a1;">🧐 持仓透视</b><br/>
<span style="color:#64748b;">完整持仓推算 + 十大重仓股实时行情，表头与股票名列双向固定</span>

<sub>季报前十大 + 全量报告缩放 · 单日净值约束优化 · 长名称悬浮</sub>

</td>
<td width="50%" valign="top" style="background:#f0fdfa;border-radius:12px;border-left:4px solid #14b8a6;padding:14px 16px;">

<b style="font-size:1.05rem;color:#0f766e;">🖼️ 识图导入</b><br/>
<span style="color:#64748b;">拖拽或粘贴持仓截图，视觉模型自动识别批量添加，识别结果可编辑校验</span>

<sub>GLM-4V 视觉模型 · 批量导入 · 结果可编辑校验</sub>
