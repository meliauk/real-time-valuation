  ...
  <div class="fund-detail-pane">
    ...
    <header class="detail-header glass-card" :style="headerBg">
      ...
      <div class="header-meta">
        ...
        <span v-if="settingsStore.enablePrediction && realtimeGszzl != null && !isHiddenRtSource" :class="['meta-realtime', realtimeGszzl > 0 ? 'rt-rise' : realtimeGszzl < 0 ? 'rt-fall' : 'rt-flat']">
          <span class="rt-line">
